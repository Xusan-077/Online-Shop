  ...
  return (
    <footer className="footer text-gray-300 py-8 mt-16">
      <div className="footer__container container mx-auto px-6">
        <ul>
          <div className="flex justify-between pb-[50px] border-b border-b-gray-300">
            <div className="flex flex-col">
              <h3 className="text-[14px] font-semibold mb-4 text-black">
                {t("footer.about")}
              </h3>
              <ul>
                <li className="text-[12px] text-gray-600 mb-[19px]">
                  {t("footer.contact")}
                </li>
                <li className="text-[12px] text-gray-600 mb-[19px]">
                  {t("footer.faq")}
            ...
            <div className="flex flex-col">
              <h3 className="text-[14px] font-semibold mb-4 text-black">
                {t("footer.for_business")}
              </h3>
              <ul>
                <li className="text-[12px] text-gray-600 mb-[19px]">
                  {t("footer.sell_on_uzum")}
                </li>
                <li className="text-[12px] text-gray-600 mb-[19px]">
                  {t("footer.seller_login")}
                </li>
                <li className="text-[12px] text-gray-600 mb-[19px]">
                  {t("footer.open_pickup_point")}
                </li>
              </ul>
            </div>
            ...
            <div className="flex flex-col w-[220px]">
              ...
              <div className="my-[15px] flex justify-between">
                <div className="flex gap-[5px] items-center">
                  ...
                  <b className="text-black text-3 font-300">
                    {t("footer.appstore")}
                  </b>
                </div>
